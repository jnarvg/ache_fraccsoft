...
<div class="content mt-3">
  ...
  <div class="card">
    <div class="card-body">
      ...
      @endif
      {!! Form::open(array('route'=>'reportes_medio_contacto', 'method'=>'get', 'autocomplete'=>'off')) !!}
        <div class="row">
          <div class="col-md-6">
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="form-group">
            <label>Total de prospectos</label>
            <input type="number" class="form-control" name="total_prospectos" id="total_prospectos" value="{{ $total_prospectos }}">
          </div>
        </div>
      </div>
    </div>
