...
<div class="content mt-3">
  ...
  <div class="card">
    <div class="card-body">
      ...
      @endif
      {!! Form::open(array('route'=>'reportes_estatus_propiedad', 'method'=>'get', 'autocomplete'=>'off')) !!}
        <div class="row">
          <div class="col-md-6">
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="form-group">
            ...
            <input type="number" class="form-control" name="total_propiedades" id="total_propiedades" value="{{ $total_propiedades }}">
          </div>
        </div>
      </div>
    </div>
