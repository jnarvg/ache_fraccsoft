<div class="modal collapse" aria-hidden="true" role="dialog" tabindex="-1" id="modal_prospecto{{ $unidad->id_propiedad }}">
                      ...
                      <div class="form-group">
                          ...
                          <select name="nuevo_proyecto_mdl" id="nuevo_proyecto_mdl" value=""  class="letrasModal form-control">
                            ...
                            @foreach ($proyectos as $py)
                              @if($unidad->proyecto_id == $py->id_proyecto)
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <select name="nuevo_propiedad_mdl" id="nuevo_propiedad_mdl" class="letrasModal form-control selectpicker" data-live-search="true">
                            <option selected value="{{ $unidad->id_propiedad }}">{{ $unidad->nombre }}</option>
                          </select>
                      </div>
                  </div>
                  <div class="col-md-12">
