...
<div class="content mt-3">
          ...
          <div class="input-group md-form form-sm form-4 pl-0">
            <select class="form-control"  name="proyecto_bs" id="proyecto_bs" >
              @foreach ($proyectos as $py)
                @if ($py->id_proyecto == $request->proyecto_bs )
  ...
  @if (!empty($one_proyecto))
  <div class="card">
    <div class="card-body">
      <div class="row">
        <div  class="col-lg-12" align="center">
          <h4>{{ $one_proyecto->nombre }}</h4>
          <hr>
        </div>
      </div>
      @if ($one_proyecto->plano_mapa == null or $one_proyecto->plano_mapa == '')
        <div class="row">
          <div  class="col-lg-12" align="center">
            <p>No hay plano cargado para este proyecto</p>
          </div>
        </div>
      @else
        @if (count($niveles) > 0)
        ...
        @else
          <div class="row">
            <div  class="col-lg-12 scrolling">
              <img class="map" width="1200" height="800" src="{{ asset($one_proyecto->plano_mapa) }}" usemap="#image-map">
              <map name="image-map">
