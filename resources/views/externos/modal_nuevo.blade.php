              ...
              <div class="row">
                  <div class="col-md-6">
                      <div class="form-group">
                          <label for="nuevo_nombre_mdl">*Nombre</label>
                          <input type="text" name="nuevo_nombre_mdl" id="nuevo_nombre_mdl" value=""  class="letrasModal form-control" required="true" />
                      </div>
                  </div>
                  <div class="col-md-6">
                      <div class="form-group">
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <select name="nuevo_medio_contacto_mdl" id="nuevo_medio_contacto_mdl" value=""  class="letrasModal form-control">
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <select name="nuevo_propiedad_mdl" id="nuevo_propiedad_mdl" class="letrasModal form-control">
