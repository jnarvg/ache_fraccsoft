...
<div class="content mt-3">
  <div class="card collapse" id="filtros">
    <div class="card-body">
      {!! Form::open(array('route'=>'v_contrato', 'method'=>'get', 'autocomplete'=>'off')) !!}
        <div class="row">
          <div class="col-md-3">
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <select class="form-control" placeholder="Estatus" name="estatus_bs[]" id="estatus_bs" multiple="multiple">
                <option selected="true" value="6">Contrato</option>
              </select>
            </div>
          </div>
          <div class="col-md-3">
      ...
      <div class="table-responsive ">
        <table class="table table-hover table-withoutborder text-sm">
          ...
          <tbody>
            ...
            <tr>
              <td class="center">
                <a class="text-dark" href="{{URL::action('ProspectosController@show', [ $prospecto->id_prospecto, 'v_contrato' ])}}" >
                {{ $prospecto->nombre}}</a>
              </td>
              <td class="center">
                <a class="text-dark" href="{{URL::action('ProspectosController@show', [ $prospecto->id_prospecto, 'v_contrato' ])}}" >
              ...
              <td class="center-acciones">
                <a href="{{URL::action('ProspectosController@show', [ $prospecto->id_prospecto, 'v_contrato' ])}}" ><button class="btn-ico" ><i class="fas fa-pencil-alt"></i></button></a>
