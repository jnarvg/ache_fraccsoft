...
@section('title')
Prospectos postergados
@endsection
@section('filter')
  <a href="#" data-toggle="modal" data-target="#modal_prospecto"><button class="mb-0 d-sm-inline-block btn btn-dark btn-sm"><i class="fas fa-plus text-xl"></i></button></a>
    {{ Form::open(array('action'=>array('ProspectosController@exportExcel'),'method'=>'get', 'class'=>'d-sm-inline-block')) }}
      ...
      <button class="btn btn-dark d-sm-inline-block btn-sm "><i class="fas fa-cloud-download-alt text-xl"></i></button>
    {!! Form::close() !!}
  <button href="#" data-toggle="collapse" data-target="#filtros" role="button" aria-expanded="false" aria-controls="filtros" class="mb-0 d-sm-inline-block btn btn-dark btn-sm"><i class="fas fa-filter text-xl"></i></button>
@endsection
@section('content')
<div class="content mt-3">
  <div class="card collapse" id="filtros">
    <div class="card-body">
      {!! Form::open(array('route'=>'v_postergado', 'method'=>'get', 'autocomplete'=>'off')) !!}
        <div class="row">
          <div class="col-md-3">
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <select class="form-control" placeholder="Estatus" name="estatus_bs[]" id="estatus_bs" multiple="multiple">
                <option selected="true" value="12">Postergado</option>
              </select>
            </div>
          </div>
          <div class="col-md-3">
      ...
      <div class="table-responsive ">
        <table class="table table-hover table-withoutborder text-sm">
          ...
          <tbody>
            ...
            <tr>
              <td class="center">
                <a class="text-dark" href="{{URL::action('ProspectosController@show', $prospecto->id_prospecto)}}" >
                {{ $prospecto->nombre}}</a>
              </td>
              <td class="center">
                <a class="text-dark" href="{{URL::action('ProspectosController@show', $prospecto->id_prospecto)}}" >
              ...
              <td class="center">
                <a class="text-dark" href="{{URL::action('ProspectosController@show', $prospecto->id_prospecto)}}" >
                {{ $prospecto->fecha_recontacto}}</a>
              </td>
              <td class="center-acciones">
                <a href="{{URL::action('ProspectosController@show', $prospecto->id_prospecto)}}" ><button class="btn-ico"><i class="fas fa-pencil-alt"></i></button></a>
