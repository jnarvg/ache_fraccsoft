        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <select class="form-control selectpicker" placeholder="Estatus" name="estatus_bs[]" id="estatus_bs" multiple="multiple" data-live-search="true">
                @foreach ($estatus_crm as $p)
                  @php $valida = 0; @endphp
                  @if ($request->estatus_bs)
                    @foreach ($request->estatus_bs as $e)
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <select class="form-control selectpicker" placeholder="Estatus" name="agente_bs[]" id="agente_bs" multiple="multiple" data-live-search="true">
                @foreach ($users as $p)
                  @php $valida = 0; @endphp
                  @if ($request->agente_bs)
                    @foreach ($request->agente_bs as $e)
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <select class="form-control selectpicker" placeholder="Estatus" name="medio_contacto_bs[]" id="medio_contacto_bs" multiple="multiple" data-live-search="true">
                @foreach ($medios_contacto as $p)
                  @php $valida = 0; @endphp
                  @if ($request->medio_contacto_bs)
                    @foreach ($request->medio_contacto_bs as $e)
      ...
      <div class="table-responsive ">
        <table class="table table-hover table-withoutborder text-sm">
          ...
          <tbody>
            ...
            <tr>
              <td class="center">
                <a class="text-dark" href="{{URL::action('ProspectosController@show', [ $prospecto->id_prospecto, 'prospectos' ])}}" >
              ...
              <td class="center-acciones">
                <a href="{{URL::action('ProspectosController@show', [ $prospecto->id_prospecto, 'prospectos' ])}}" ><button class="btn-ico" ><i class="fas fa-pencil-alt"></i></button></a>
