            ...
            <table align="right">
                <tr>
                    <td height="70" class="viewWebsite">
                        <p style="font-family: Arial, Helvetica, sans-serif; color: #f6f6f6; font-size: 18; padding: 25px; margin: 10px;">Nuevo mensaje</p>
                    </td>
                </tr>
            </table>
        </td>
...
<table width="630" bgcolor="#fcfcfc" style="border: 1px solid #dddddd; line-height: 135%;" class="container" align="center" cellpadding="0" cellspacing="0">
            ...
            <table>
                <tr>
                    ...
                    <td align="center" class="bodyCopy">
                        <h1 style="font-family: Arial, Helvetica, sans-serif; font-size: 30px; color: #404040; margin-top: 0; margin-bottom: 20px; padding: 0; line-height: 135%" class="headline">Usted a recibido el siguiente mensaje:</h1>
                        <textarea style="font-family: Arial, Helvetica, sans-serif; color: #555555; fontnota-size: 14px; padding: 0 40px;"> <b>{!! $nota !!}</b> </textarea>
                        <p></p>
                        <p>De parte de, {!! $remitente !!}</p>
                    </td>
                    <td width="30" class="spacer">&nbsp;</td>
                </tr>
            </table>
    ...
    <tr>
        <td colspan="3" align="center">
            <img src="{{ asset('./assets/images/sidebar-8.png') }}" width="100%" height="85px">
        </td>
    </tr>
</table>
</body>
