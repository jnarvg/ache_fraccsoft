...
<div class="content mt-3">
      ...
      <div class="table-responsive ">
        <table class="table table-hover table-withoutborder text-sm" id="tabla">
          ...
          <tbody>
            ...
            <tr>
              <td class="center">
                <a class="text-dark" href="{{URL::action('TipoPropiedadController@show', $tipo->id_tipo_propiedad)}}" >
                {{ $tipo->tipo_propiedad}}</a>
              </td>
              <td class="center-acciones">
                <a href="{{URL::action('TipoPropiedadController@show', $tipo->id_tipo_propiedad)}}" ><button class="btn-ico" ><i class="fas fa-pencil-alt"></i></button></a>
                @if (auth()->user()->rol == 3)
                <a href="{{URL::action('TipoPropiedadController@destroy', $tipo->id_tipo_propiedad)}}" ><button class="btn-ico" ><i class="fas fa-trash-alt"></i></button></a>               
                @endif
              </td>
            </tr>
            @endforeach
  ...
  {{-- {{$TiposPropiedad->render()}} --}}
</div>
<div class="modal collapse" aria-hidden="true" role="dialog" tabindex="-1" id="modal-uso_propiedad">
  {{ Form::open(array('action'=>array('TipoPropiedadController@store'),'method'=>'post')) }}
  <div class="modal-dialog" role="document">
      <div class="modal-content">
          <div class="modal-header">
              <h4 class="modal-title text-dark">Nuevo tipo de propiedad</h4>
