...
class CatalogosAjaxController extends Controller
{
    ...
    public function CatalogosGrupoEsquema($id, $uso){
        $catalogo = DB::table('grupo_esquema') /*Estados*/
        ->select('id_grupo_esquema','grupo_esquema') /**/
        ->where('proyecto_id','=',$id)
        ->where('uso_propiedad_id','=',$uso)
        ->get();
        return response()->json($catalogo);
    }

    public function CatalogosDetalleCotizacionPropiedad($id, $propiedad){
        $catalogo = DB::table('detalle_cotizacion_propiedad') /*Estados*/
        ->select('id_detalle_cotizacion_propiedad','esquema_pago') /**/
        ->where('cotizacion_id','=',$id)
        ->where('propiedad_id','=',$propiedad)
        ->get();
        return response()->json($catalogo);
    }
